...
(define (deriv expn var)
    (cond ((number? expn) 0)  
          ...
          ((expt? expn)(cond ((number? (multiplicand expn))(make-product (make-product (multiplicand expn)
          ...
          ((exp? expn)(make-product (make-exp (ang expn))
                                    (deriv (ang expn) var)))
          ((inverse-sin? expn)(make-product (make-div 1 (make-expt (make-sub 1 (make-expt (ang expn) 2)) 0.5)) 
                                            (deriv (ang expn) var)))
          ((inverse-cos? expn)(make-product (make-div (- 0 1) (make-expt (make-sub 1 (make-expt (ang expn) 2)) 0.5))
                                            (deriv (ang expn) var)))
          ((inverse-tan? expn)(make-product (make-div 1 (make-sum 1 (make-expt (ang expn) 2)))
                                            (deriv (ang expn) var)))
          ((inverse-cosec? expn)(make-product (make-div (- 0 1) (make-product (ang expn) 
                                                                              (make-expt (make-sub (make-expt (ang expn) 2) 1) 0.5)))
                                              (deriv (ang expn) var)))
          ((inverse-sec? expn)(make-product (make-div 1 (make-product (ang expn) (make-expt (make-sub (make-expt (ang expn) 2) 1) 0.5)))
                                            (deriv (ang expn) var)))
          ((inverse-cot? expn)(make-product (make-div (- 0 1) (make-sum 1 (make-expt (ang expn) 2)))
                                            (deriv (ang expn) var)))      
