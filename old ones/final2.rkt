...
(define (make-product m1 m2)
  (cond ((or(=numbere? m1 (list 'scheme-number 0.0))(=numbere? m2 (list 'scheme-number 0.0))) (list 'scheme-number 0.0))
        ((=numbere? m1 (list 'scheme-number 1.0)) m2)
        ((=numbere? m2 (list 'scheme-number 1.0)) m1)
...
(define (make-expt p1 p2)
  (cond ((=numbere? p1 (list 'scheme-number 0.0)) (list 'scheme-number 0.0))
        ((or (=numbere? p1 (list 'scheme-number 1.0)) (=numbere? p2 (list 'scheme-number 0.0))) (list 'scheme-number 1.0))
        ((=numbere? p2 (list 'scheme-number 1.0)) p1)
...
(define (deriv expn var)
    (cond ((numbere? expn) (list 'scheme-number 0.0))  
          ((variable? expn) (if (same-variable? expn var) (list 'scheme-number 1.0) (list 'scheme-number 0.0)))
          ...
          ((cos? expn)(make-product (make-sub (list 'scheme-number 0.0) (make-sin (ang expn)))
                                    (deriv (ang expn) var)))
          ((tan? expn)(make-product (make-expt (make-sec (ang expn)) (list 'scheme-number 2))
                                    (deriv (ang expn) var)))
          ...
          ((sec? expn)(make-product (make-product (make-sec (ang expn))
                                                  (make-tan (ang expn)))
                                    (deriv (ang expn) var)))
          ((cot? expn)(make-product (make-sub (list 'scheme-number 0.0) (make-expt (make-cosec (ang expn)) (list 'scheme-number 2)))
                                    (deriv (ang expn) var)))
          ((log? expn)(make-product (make-div (list 'scheme-number 1.0) (ang expn))
                                    (deriv (ang expn) var)))
          ((exp? expn)(make-product (make-exp (ang expn))
                                    (deriv (ang expn) var)))
          ((inverse-sin? expn)(make-product (make-div (list 'scheme-number 1.0) (make-expt (make-sub (list 'scheme-number 1.0) (make-expt (ang expn) (list 'scheme-number 2))) (list 'scheme-number 0.0) (list 'scheme-number 0.5))) 
                                            (deriv (ang expn) var)))
          ((inverse-cos? expn)(make-product (make-div (- (list 'scheme-number 0.0) (list 'scheme-number 1.0)) (make-expt (make-sub (list 'scheme-number 1.0) (make-expt (ang expn) (list 'scheme-number 2))) (list 'scheme-number 0.0) (list 'scheme-number 0.5)))
                                            (deriv (ang expn) var)))
          ((inverse-tan? expn)(make-product (make-div (list 'scheme-number 1.0) (make-sum (list 'scheme-number 1.0) (make-expt (ang expn) (list 'scheme-number 2))))
                                            (deriv (ang expn) var)))
          ((inverse-cosec? expn)(make-product (make-div (- (list 'scheme-number 0.0) (list 'scheme-number 1.0)) (make-product (ang expn) 
                                                                              (make-expt (make-sub (make-expt (ang expn) (list 'scheme-number 2)) (list 'scheme-number 1.0)) (list 'scheme-number 0.0) (list 'scheme-number 0.5))))
                                              (deriv (ang expn) var)))
          ((inverse-sec? expn)(make-product (make-div (list 'scheme-number 1.0) (make-product (ang expn) (make-expt (make-sub (make-expt (ang expn) (list 'scheme-number 2)) (list 'scheme-number 1.0)) (list 'scheme-number 0.0) (list 'scheme-number 0.5))))
                                            (deriv (ang expn) var)))
          ((inverse-cot? expn)(make-product (make-div (- (list 'scheme-number 0.0) (list 'scheme-number 1.0)) (make-sum (list 'scheme-number 1.0) (make-expt (ang expn) (list 'scheme-number 2))))
                                            (deriv (ang expn) var)))      
